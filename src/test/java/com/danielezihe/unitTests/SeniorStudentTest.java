...
public class SeniorStudentTest {
    ...
    void checksIfABookRequestReturnsTheActualBookRequested() {
        ...
        Books requestedBook = seniorStudent.requestBook(bookId);
        Books correctBookWithThatId = seniorStudent.requestBook(bookId);
    ...
    void checksIfABookRequestReturnsBookTakenIfBookIsTaken() {
        ...
        Books books = seniorStudent.requestBook(bookId);
